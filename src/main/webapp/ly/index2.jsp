...
<body>
<form name="form1" action="tj_chk2.jsp" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="140" align="center" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="center" valign="middle"><h1>监督建言-乐清客货运中心</h1></td>
            </tr>
        </table></td>
    </tr>
                ...
                <td align="center" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><table width="100%" cellspacing="5" cellpadding="0">
                            <tr>
                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;最多跑一次”改革是习近平总书记以人民为中心的发展思想在浙江的生动实践，是新时代浙江推进“八八战略”再深化、改革开放再出发的牵动性举措，是高水平推进省域治理现代化的关键路径。2019年年初召开的浙江省委改革委第二次会议提出，要把人流密集的汽车站、火车站、景区等公共场所作为“最多跑一次”改革攻坚重点。乐清客货运中心服务提升项目已向社会展示，欢迎大家批评监督，恳请大家继续为乐清客货运中心服务大提升出好点子。</td>
                            </tr>
                        </table></td>
                    </tr>
                </table></td>
    ...
    <tr>
        <td height="10" align="center" valign="top"><table width="90%" height="50" cellspacing="0" cellpadding="0" style="border-radius: 10px; background: #900;">
            <tr>
                <td align="center" valign="middle" onClick="document.form1.action='tj_chk2.jsp';if(DataLength(form1.memo.value)<2){alert('请填写留言');form1.memo.focus();return false};document.form1.submit();">
                    <m>
